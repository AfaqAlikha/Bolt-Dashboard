    ...
    const getAllUsers = async () => {
      ...
      try {
        ...
        if (snapshot.exists()) {
          ...
          // TOTLE ACTIVE USERS
          const filteredUsersunactive = Object.values(allUsers).filter(
          ...
          const filteredUsersLoked = Object.values(allUsers).filter(
            (user) => user.screenLock?.locked === true
          );
          const TOTLUNELOKEDUSER = Object.values(filteredUsersLoked);
          setTotalLockedUserCount(TOTLUNELOKEDUSER.length);
          // TOTLE Loked USERS

          const filteredUsersUnLoked = Object.values(allUsers).filter(
    ...
    <main className="px-2">
      <div>
        <div className="row gap-2">
          ...
          >
            <Link to="/inactive-users" className="text-decoration-none">
              <div className="d-flex flex-column align-items-center">
                <PersonIcon sx={{ fontSize: 40, color: "white" }} />
                <h5
                  style={{ fontSize: "14px", marginBlock: "5px" }}
          ...
          <div
            ...
            style={{ background: "linear-gradient(to bottom, red, green)" }}
          >
            <Link to="/locked-customers" className="text-decoration-none">
              <div className="d-flex flex-column align-items-center">
          ...
          >
            <Link to="/unlocked-customers" className="text-decoration-none">
              <div className="d-flex flex-column align-items-center">
          ...
          >
            <Link to="/add-users" className="text-decoration-none">
              <div className="d-flex flex-column align-items-center">
          ...
          >
            <Link to="/all-users" className="text-decoration-none">
              <div className="d-flex flex-column align-items-center">
                <PersonIcon sx={{ fontSize: 40, color: "white" }} />
                <h5
                  style={{ fontSize: "14px", marginBlock: "5px" }}
