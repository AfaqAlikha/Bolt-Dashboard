...
function DashboardLayout() {
    ...
    const responsiveDrawer = (
        <div style={{ backgroundColor: "#09212E", height: "100%" }}>
            <Toolbar />
            <Divider />
           <Box  sx={{ textAlign: "center", color: "white", fontSize: 20 }}>
           ...
           <Typography
            ...
            <List sx={{ backgroundColor: "#09212E" }}>
                ...
                <ListItemButton component={Link} to="/all-users" sx={{ color: "white" }}>
                    <ListItemIcon sx={{ color: "white" }}>
                        <GroupIcon />
                    </ListItemIcon>
                    <ListItemText primary={"All Users"} />
                </ListItemButton>
                <ListItemButton component={Link} to="/active-users" sx={{ color: "white" }}>
                    <ListItemIcon sx={{ color: "white" }}>
                        <PersonIcon />
                    </ListItemIcon>
                    <ListItemText primary={"Active Users"} />
                </ListItemButton>
                <ListItemButton component={Link} to="/inactive-users" sx={{ color: "white" }}>
                    <ListItemIcon sx={{ color: "white" }}>
                        <PersonOffIcon />
                    </ListItemIcon>
                    <ListItemText primary={"InActive Users"} />
                </ListItemButton>
                <ListItemButton component={Link} to="/add-users" sx={{ color: "white" }}>
                    <ListItemIcon sx={{ color: "white" }}>
                        <PersonAddIcon />
                    </ListItemIcon>
                    <ListItemText primary={"Add Users"} />
                </ListItemButton>
                <ListItemButton component={Link} to="/locked-customers" sx={{ color: "white" }}>
                    <ListItemIcon sx={{ color: "white" }}>
                        <LockIcon />
                    </ListItemIcon>
                    <ListItemText primary={"Locked Customers"} />
                </ListItemButton>
                <ListItemButton component={Link} to="/unlocked-customers" sx={{ color: "white" }}>
                    <ListItemIcon sx={{ color: "white" }}>
                        <LockOpenIcon />
                    </ListItemIcon>
        ...
        <Box sx={{ display: "flex" }}>
            ...
            >
                <Toolbar>
                    ...
                    <Box sx={{ width:"100%", display:"flex", alignItems:"center",justifyContent:"end", gap:"20px"}}>
                    <Box sx={{display:"flex", flexDirection:"column", alignItems:"center"}}>
        <PersonIcon style={{width:"30px", height:"30px", borderRadius:"50%", color:"white"}}/>
